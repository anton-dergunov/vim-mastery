...
export class StoryTransitions {
  ...
  renderEnding() {
    ...
    this.elements.surface.dataset.panelId = "restored-wilds";
    this.elements.visual.dataset.panelId = "restored-wilds";
    ...
    this.elements.visual.setAttribute("aria-label", "The four restored Vim Wilds celebrating together");
    this.elements.progress.textContent = "All four worlds restored";
    this.elements.kicker.textContent = this.active.replay ? "Finale replay" : "The Wilds remember";
    this.elements.title.textContent = "The Wilds are alive";
