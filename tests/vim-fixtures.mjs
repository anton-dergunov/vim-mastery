...
export const conformanceFixtures = Object.freeze([
  ...
  {
    id: "file-name-register-put",
    initialCode: ["# source:", "value = 1"],
    cursor: [0, 8],
    keys: ["\"", "%", "p"],
    fileName: "report.py",
    registerNames: ["%"],
    targetCode: ["# source:report.py", "value = 1"],
    targetCursor: [0, 17],
    targetRegisters: { "%": { text: "report.py", type: "characterwise" } },
  },
  {
    id: "file-name-register-insert-mode",
    initialCode: ["# generated from ", "value = 1"],
    cursor: [0, 0],
    keys: ["A", "Ctrl-r", "%", "Escape"],
    fileName: "report.py",
    registerNames: ["%"],
    targetCode: ["# generated from report.py", "value = 1"],
    targetCursor: [0, 25],
    targetRegisters: { "%": { text: "report.py", type: "characterwise" } },
  },
  {
    id: "file-name-register-on-command-line",
    initialCode: ["path = ''", "path = ''"],
    cursor: [0, 0],
    keys: [...":%s/''/'", "Ctrl-r", "%", ..."'/", "Enter"],
    fileName: "config.toml",
    registerNames: ["%"],
    targetCode: ["path = 'config.toml'", "path = 'config.toml'"],
    targetCursor: [1, 0],
    targetRegisters: { "%": { text: "config.toml", type: "characterwise" } },
  },
  {
    id: "file-name-register-is-read-only",
    initialCode: ["alpha", "beta"],
    cursor: [0, 0],
    keys: ["\"", "%", "y", "y", "\"", "%", "p"],
    fileName: "notes.txt",
    registerNames: ["%"],
    targetCode: ["anotes.txtlpha", "beta"],
    targetCursor: [0, 9],
    targetRegisters: { "%": { text: "notes.txt", type: "characterwise" } },
  },
  {
